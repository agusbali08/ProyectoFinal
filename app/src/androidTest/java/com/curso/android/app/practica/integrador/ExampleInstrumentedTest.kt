...
class MainActivityUITest {
    ...
    fun testCompararButtonClick() {
        ...
        onView(withId(R.id.resultado)).check(matches(withText("Las cadenas de caracteres son iguales.")))
    }
    ...
    fun testCompararButtonEmptyStrings() {
        ...
        onView(withId(R.id.resultado)).check(matches(withText("Introduci dos cadenas de caracteres.")))
    }
}
